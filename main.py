...
async def post_init(app: Application) -> None:
    ...
    commands = [
        ...
        BotCommand("pomoc", "Lista wszystkich komend"),
        BotCommand("dzisiaj", "Wybierz ligę i pokaż mecze"),
        BotCommand("mecze", "Dzisiejsze mecze"),
        BotCommand("ligi", "Lista obsługiwanych lig"),
        BotCommand("liga", "Alias listy lig"),

        BotCommand("kupon", "Kreator kuponu pod kurs docelowy"),
        BotCommand("profil", "SAFE / NORMAL / RISKY"),
        BotCommand("anuluj", "Przerwij kreator"),

        BotCommand("betbuilder", "Bet Builder z jednego meczu"),
        BotCommand("builder", "Alias Bet Buildera"),
        BotCommand("builder_mecz", "Wybierz mecz do Buildera"),
        BotCommand("builder_gole", "Builder tylko gole"),
        BotCommand("builder_rogi", "Builder tylko rzuty rożne"),
        BotCommand("builder_kartki", "Builder tylko kartki"),
        BotCommand("builder_strzaly", "Builder tylko strzały"),
        BotCommand("builder_celne", "Builder tylko strzały celne"),
        BotCommand("builder_faule", "Builder tylko faule"),

        BotCommand("stawiam", "Oznacz kupon jako faktycznie zagrany"),
        BotCommand("niegram", "Usuń aktywny kupon ze statystyk"),
        ...
        BotCommand("wyniki", "Ostatnie rozliczone typy"),
        BotCommand("dzisiaj_wyniki", "Dzisiejsze wyniki typów"),
        BotCommand("bilans", "Bilans AKO i selekcji"),
        BotCommand("statystyki", "Pełne statystyki"),
        BotCommand("statystyki_bota", "Alias statystyk"),
        BotCommand("yield", "Yield według rynków"),
        BotCommand("roi", "ROI / alias yield"),
        BotCommand("seria", "Aktualna seria wyników"),
        BotCommand("tydzien", "Raport ostatnich 7 dni"),
        BotCommand("miesiac", "Raport bieżącego miesiąca"),
        ...
        BotCommand("status", "Status Telegram/API/bazy/schedulera"),
    ]
